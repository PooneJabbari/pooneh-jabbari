            ...
            <div className="relative bg-gradient-to-br from-background via-background to-primary-950/20 border-2 border-yellow-500/30 rounded-2xl shadow-2xl shadow-yellow-500/20 overflow-hidden">
              ...
              <div className="relative p-8 space-y-6">
                ...
                <div className="space-y-3 pt-4 border-t border-foreground/10">
                  ...
                  <a
                    href={`mailto:${content.contact.email}?subject=Portfolio Feedback - All Achievements Completed!&body=Hi Pooneh,%0D%0A%0D%0AI've just completed all achievements on your portfolio! Here's my feedback:%0D%0A%0D%0A`}
